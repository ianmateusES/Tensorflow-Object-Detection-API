...
#
## You can also use any of the above mentioned codes and do the needful changes or else just follow code given below
"""
...
PATH_TO_LABELS = os.path.join(CWD_PATH,'training','labelmap_narenltk.pbtxt')
